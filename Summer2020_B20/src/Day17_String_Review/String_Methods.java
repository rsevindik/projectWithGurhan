...
/*
 ...
 equals, equalsIgnoreCase, isEmpty, ends, starts, contains
     */
            ...
            int l =  str3.length(); //15 means there are 15 characters/letters
            System.out.println("length: "+l);

            // last index: length -1

            char ch2 = str3.charAt(l-1); // str3.length()-1 ==? 15 - 1 ===> 14  gives you the last index number for the last char.!
            ...
            //trim()
            String str6 = " ";  // only works for the white space before and after the word
            // but not in between because spaces between the words separate them.!
            System.out.println(str6);

            str6 = str6.trim(); // "Cybertek"
            System.out.println("rssss"+str6);
            boolean A=str6.isEmpty();
